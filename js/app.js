    ...
    (() => {
        ...
        class BeforeAfter {
            ...
            beforeAfterItemInit(beforeAfter) {
                ...
                if (beforeAfterArrow) if (beforeAfterArrow) beforeAfterArrow.addEventListener("pointerdown", beforeAfterDrag);
                function beforeAfterDrag(e) {
                    ...
                    e.type;
                    e.type;
                    document.addEventListener("pointermove", beforeAfterArrowMove);
                    document.addEventListener("pointerup", (function() {
                        document.removeEventListener("pointermove", beforeAfterArrowMove);
                    }), {
                        once: true
                    });
                }
        ...
        class Popup {
            ...
            close(selectorValue) {
                ...
                this.previousOpen.element.setAttribute("aria-modal", "true");
                if (!this._reopen) {
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                new swiper_core_Swiper(".proposals__slider", {
                    ...
                    navigation: {
                        prevEl: ".proposals__prev",
                        nextEl: ".proposals__next"
                    },
                    on: {}
                });
                var swiper = new swiper_core_Swiper(".slider-offer", {
                    loop: true,
                    spaceBetween: 10,
                    slidesPerView: 5,
                    freeMode: true,
                ...
                new swiper_core_Swiper(".slider-offer-2", {
                    ...
                    speed: 800,
                    navigation: {
                        nextEl: ".slider-offer-2-next",
                        prevEl: ".slider-offer-2-prev"
                    },
                    thumbs: {
                        swiper
                    }
...
***************************************************************************** */
        ...
        if (galleries.length) {
            ...
            galleries.forEach((gallery => {
                ...
                if (gallery.id === "gallery-one") {
                    const dynamicImgEl = [ {
                        src: "img/inzerat/gallery/full-1.webp",
                        thumb: "img/inzerat/gallery/thumb/thumb-1.webp"
                    }, {
                        src: "img/inzerat/gallery/full-2.webp",
                        thumb: "img/inzerat/gallery/thumb/thumb-2.webp"
                    }, {
                        src: "img/inzerat/gallery/full-3.webp",
                        thumb: "img/inzerat/gallery/thumb/thumb-3.webp"
                    }, {
                        src: "img/inzerat/gallery/full-4.webp",
                        thumb: "img/inzerat/gallery/thumb/thumb-4.webp"
                    }, {
                        src: "img/inzerat/gallery/full-5.webp",
                        thumb: "img/inzerat/gallery/thumb/thumb-5.webp"
                    }, {
                        src: "img/inzerat/gallery/full-6.webp",
                        thumb: "img/inzerat/gallery/thumb/thumb-6.webp"
                    }, {
                        src: "img/inzerat/gallery/full-7.webp",
                        thumb: "img/inzerat/gallery/thumb/thumb-7.webp"
                    }, {
                        src: "img/inzerat/gallery/full-8.webp",
                        thumb: "img/inzerat/gallery/thumb/thumb-8.webp"
                    }, {
                        src: "img/inzerat/gallery/full-9.webp",
                        thumb: "img/inzerat/gallery/thumb/thumb-9.webp"
                    }, {
                        src: "img/inzerat/gallery/full-10.webp",
                        thumb: "img/inzerat/gallery/thumb/thumb-10.webp"
                    } ];
                    gallerySettings = {
                        dynamic: true,
                ...
                const galleryInstance = lightgallery_es5(gallery, gallerySettings);
                galleyItems.push({
                    id: gallery.id,
                    element: gallery,
                ...
                galleyItems.forEach((item => {
                    if (item.id === "gallery-one") {
                        const galleryElements = document.querySelectorAll(".gallery a");
                        const dynamicGallerybtn = document.querySelector(".offer-page__button");
                        dynamicGallerybtn.addEventListener("click", (function() {
                            galleryInstance.openGallery(4);
                        }));
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            const menuLinks = document.querySelectorAll(".menu__link, .spollers__link a");
            menuLinks.forEach((link => {
                ...
                if (linkUrl === currentUrl) {
                    ...
                    if (parentDetails) {
                        const summaryLink = parentDetails.querySelector(".spollers__title .menu__link");
                        if (summaryLink) summaryLink.classList.add("_active");
                    }
                }
            }));
            ...
            if (servicesSection) {
                ...
                const sliderImages = document.querySelectorAll(".slider-services__image");
                sliderContainer.addEventListener("mouseenter", (() => {
                    const firstImage = sliderImages[0];
                    if (firstImage.classList.contains("_active")) firstImage.classList.remove("_active");
                }));
                sliderContainer.addEventListener("mouseleave", (() => {
                    const firstImage = sliderImages[0];
                    if (!firstImage.classList.contains("_active")) firstImage.classList.add("_active");
                }));
            ...
            const callButton = document.querySelector(".page__action");
            if (callButton) window.addEventListener("scroll", (() => {
                ...
                if (bodyPosition < viewportHeight * -.75 && footerPosition > viewportHeight) callButton.classList.add("visible"); else callButton.classList.remove("visible");
            }));
        }));
        window["FLS"] = true;
        addLoadedClass();
