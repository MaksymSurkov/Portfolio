(() => {
    ...
    function headerScroll() {
        ...
        let timer;
        main.addEventListener("windowScroll", (function(e) {
    ...
    function updateParallax(scrollY) {
        ...
        if (fullscreen.classList.contains("_watcher-view")) !previewImg.classList.contains("visible") ? previewImg.classList.add("visible") : null;
        previewImg.style.transform = `translateY(-${offset}px)`;
    }
    function raf(time) {
    ...
    document.querySelector(".hero__container").addEventListener("click", openHeroMenu);
