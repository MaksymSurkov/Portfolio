        ...
        (() => {
            ...
            const loadMap = async onLoad => {
                const loader = new Loader({
                    apiKey: "AIzaSyAboYeyhzhjdoAeA1UjFrsEzqpmJ6hV2dw",
                    version: "weekly"
                });
                try {
            ...
            const initMap = ({api, lng, lat, markersData, zoom, maxZoom, $map}) => {
                const map = new api.Map($map, {
                    ...
                    mapId: "370c7efdf82555272f9adbb7"
                });
                ...
                const markers = markersData.map(({lat, lng, icon}) => {
                    ...
                    marker._iconUrl = icon;
                    marker.addListener("gmp-click", () => {
                        markers.forEach(m => {
                            const img = m.content;
                            img.style.width = markerSize.width + "px";
                            img.style.height = markerSize.height + "px";
                        });
