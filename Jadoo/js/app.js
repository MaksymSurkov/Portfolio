(() => {
    ...
    class Popup {
        ...
        open(selectorValue) {
            if (bodyLockStatus) {
                ...
                if (this.targetOpen.element) {
                    if (this.youTubeCode && this.targetOpen.element.querySelector(`[${this.options.youtubePlaceAttribute}]`)) {
                        ...
                        if (youtubePlace) youtubePlace.appendChild(iframe);
                    }
        ...
        close(selectorValue) {
            ...
            if (this.previousOpen.element.querySelector(`[${this.options.youtubePlaceAttribute}]`)) this.previousOpen.element.querySelector(`[${this.options.youtubePlaceAttribute}]`).innerHTML = "";
